...
async function GET() {
    const recipes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getRecipes();
...
async function POST(request) {
    try {
        ...
        if (body.imageUrl) {
            ...
            if (body.imageUrl.startsWith('/temp-uploads/')) {
                ...
                if (oldFilename && !oldFilename.startsWith(body.slug)) {
                    const recipesDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'recipes');
                    const oldPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(recipesDir, oldFilename);
                    const extension = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].extname(oldFilename);
                    const newFilename = `${body.slug}${extension}`;
                    const newPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(recipesDir, newFilename);
                    try {
        ...
        try {
            const newRecipe = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].createRecipe(body);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                recipe: newRecipe
            }, {
                status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16ba3624._.js.map