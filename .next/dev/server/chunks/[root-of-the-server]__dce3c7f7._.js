...
async function GET(request) {
    ...
    const allRecipes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getRecipes();
    const recipeMatches = allRecipes.filter((r)=>r.title.toLowerCase().includes(q) || r.description.toLowerCase().includes(q) || r.state.toLowerCase().includes(q)).slice(0, 5);
    const stateMatches = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$recipes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["states"].filter((s)=>s.name.toLowerCase().includes(q) || s.region.toLowerCase().includes(q)).slice(0, 5);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        recipeMatches,
        stateMatches
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dce3c7f7._.js.map