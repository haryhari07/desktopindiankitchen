...
"[project]/app/api/recipes/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, { params }) {
    try {
        ...
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].deleteRecipe(slug);
        if (deleted) {
            // If recipe deleted successfully, try to delete image
            if (imageUrl && imageUrl.startsWith('/recipes/')) {
                const filename = imageUrl.split('/').pop();
                if (filename) {
                    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'recipes', filename);
                    try {
            ...
            if (imageUrl && imageUrl.startsWith('https://') && imageUrl.includes('public.blob.vercel-storage.com')) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["del"])(imageUrl).catch((err)=>console.error('Failed to delete image from blob:', err));
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true
            });
...
async function PUT(request, { params }) {
    try {
        ...
        if (body.imageUrl && body.imageUrl.startsWith('https://') && body.imageUrl.includes('public.blob.vercel-storage.com') && body.imageUrl.includes('/temp-uploads/')) {
            try {
                ...
                if (filename) {
                    ...
                    const newFilename = `${slug}-${Date.now()}${extension}`;
                    const newBlob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["put"])(`recipes/${newFilename}`, Buffer.from(arrayBuffer), {
                        access: 'public',
                        contentType,
                        addRandomSuffix: false
                    });
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["del"])(body.imageUrl).catch(()=>{});
                    body.imageUrl = newBlob.url;
                    if (currentRecipe?.imageUrl && currentRecipe.imageUrl !== body.imageUrl && currentRecipe.imageUrl.startsWith('https://') && currentRecipe.imageUrl.includes('public.blob.vercel-storage.com')) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["del"])(currentRecipe.imageUrl).catch((err)=>console.error('Failed to delete old blob image:', err));
                    }
                }
            } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb07bb81._.js.map