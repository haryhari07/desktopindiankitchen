...
async function isAdmin() {
    ...
    if (session && session.user && session.user.email) {
        user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].findUserByEmail(session.user.email);
    } else {
        ...
        if (sessionId) {
            ...
            if (dbSession) {
                user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].findUserById(dbSession.userId);
            }
        }
    }
...
async function GET() {
    ...
    const users = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getAllUsers();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        users
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e828e04f._.js.map