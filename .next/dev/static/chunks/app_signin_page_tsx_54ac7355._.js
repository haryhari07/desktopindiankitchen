...
function SignInPage() {
    ...
    const { login, signup, user, refreshUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
        ...
        "SignInPage.useEffect": ()=>{
            if (status === 'authenticated' && !user) {
                const syncGoogleUser = {
                    "SignInPage.useEffect.syncGoogleUser": async ()=>{
                ...
                }["SignInPage.useEffect.syncGoogleUser"];
                syncGoogleUser();
            } else if (user) {
...
_s(SignInPage, "4WY1P8BTWWrGvuoh13sLgrCjcl0=", false, function() {
    return [
...
//# sourceMappingURL=app_signin_page_tsx_54ac7355._.js.map