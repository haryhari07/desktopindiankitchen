    ...
    <div className="min-h-[calc(100vh-120px)] bg-[var(--ak-bg-soft)] flex items-center justify-center px-4 py-10">
      <div className="max-w-md w-full">
        ...
        <p className="mt-5 text-center text-xs text-gray-500">
            ...
            <Link href="/terms" className="text-gray-700 underline hover:text-black">Terms of Service</Link>
            {' '}and{' '}
            <Link href="/privacy-policy" className="text-gray-700 underline hover:text-black">Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
