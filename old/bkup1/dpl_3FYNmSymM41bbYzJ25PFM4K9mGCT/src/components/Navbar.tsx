...
export default function Navbar() {
  ...
  return (
    <header className="border-b border-[var(--ak-border)] bg-white/95 backdrop-blur sticky top-0 z-40 shadow-sm transition-all duration-300">
      <nav className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between gap-4 md:gap-6 flex-wrap">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="h-10 w-10 rounded-2xl bg-[var(--ak-bg-soft)] border border-[var(--ak-border)] flex items-center justify-center overflow-hidden transition-transform duration-300 group-hover:scale-105 group-hover:rotate-3 flex-shrink-0">
            <Image
          ...
          <div className="leading-tight min-w-0">
            <span className="block text-lg md:text-xl font-bold font-serif text-gray-900 group-hover:text-[var(--ak-primary)] transition-colors truncate">
              Indian Kitchen
            </span>
            <span className="block text-[10px] sm:text-xs md:text-sm text-gray-500">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[var(--ak-border)] bg-white shadow-sm">
